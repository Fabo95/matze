import { dynamicCacheName, staticCacheName } from "@Interval/serviceWorker/utils/constants";
...
export const handleGetRequest = async (request) => {
    ...
    const isStaticAssetRequest = getIsStaticAssetRequest(request.url, staticAssetPaths);
