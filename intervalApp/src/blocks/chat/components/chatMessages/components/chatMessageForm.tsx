...
export const ChatMessageForm = ({ friendshipId, receiverUserId, sendMessage }: ChatMessageFormProps) => {
    // ---- STATE ---
    ...
    return (
        <Form action={handleSubmitMessage} className="chat-message-form">
            <TextareaAutosize
                ...
                minRows={1}
                name="message"
                onChange={(event: ChangeEvent<HTMLTextAreaElement>) => setCurrentMessage(event.currentTarget.value)}
