...
export type IntervalTimerExecutionOverviewButtonProps = {
    ...
    icon: ReactElement;
    intensityType: IntervalIntensityType.ROUND_COUNT | IntervalIntensityType.EXERCISE_COUNT;
    title: string;
};

export type IntervalTimerConfigurationOptionProps = Omit<IntervalTimerExecutionOverviewButtonProps, "intensityType"> & {
