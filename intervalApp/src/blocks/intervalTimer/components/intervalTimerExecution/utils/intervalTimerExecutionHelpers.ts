import { IntervalTimerExecutionBackgroundGradientStrategy } from "@Interval/blocks/intervalTimer/components/intervalTimerExecution/utils/intervalTimerExecutionTypes";
...
import { State } from "@Interval/blocks/intervalTimer/intervalTimerExecutionMachine/utils/intervalTimerExecutionTypes";

export const getIntervalTimerExecutionBackgroundGradientStrategies =
    (): IntervalTimerExecutionBackgroundGradientStrategy[] => [
        {
            isCurrentState: (intervalTimerExecutionStateValue) => intervalTimerExecutionStateValue === State.WORK_TIME,
        ...
        {
            isCurrentState: (intervalTimerExecutionStateValue) => intervalTimerExecutionStateValue === State.REST_TIME,
            setBackGroundGradient: () => {
        ...
        },
        {
            ...
            setBackGroundGradient: () => {
                if (document.body.className === "round-reset-time-background-gradient") {
                    return;
                }
        ...
        {
            isCurrentState: (intervalTimerExecutionStateValue) => intervalTimerExecutionStateValue === State.COMPLETE,
            setBackGroundGradient: () => {
                document.body.className = "";
            },
        },
...
export const executeIntervalTimerExecutionBackgroundGradientStrategy = ({
    ...
    if (backgroundGradientStrategy.isCurrentState(intervalTimerExecutionStateValue)) {
