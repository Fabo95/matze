    ...
    createMachine(
        {
            ...
            states: {
                ...
                roundResetTime: {
                    always: {
                        cond: "isRemainingRoundCountZero",
                        target: "complete",
                    },
        ...
        },
        {
            ...
            delays: {},
            guards: {
                isRemainingExerciseCountZero: (context) => context.exerciseCount.remaining === 0,
                isRemainingRoundCountZero: (context) => context.roundCount.remaining === 0,
            },
            services: {
...
export type ApplicationProcessMachine = StateFrom<typeof createIntervalTimerExecutionMachine>;
