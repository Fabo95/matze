...
import { ReactiveType, RecursiveObjectType } from "@Interval/utils/types";
...
export const getArrayWithElements = <T>({ arrayElement, arrayLength }: { arrayElement: T; arrayLength: number }) =>
...
export const scrollToBottom = (elementRef: RefObject<HTMLDivElement>, behavior: ScrollBehavior) => {
