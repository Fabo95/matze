...
export const Button_DEPRECATED = forwardRef(
    ({ buttonTitle, className, ...buttonProps }: ButtonProps, ref?: ForwardedRef<HTMLButtonElement>) => {
        // --- CALLBACKS ---
        ...
        // --- RENDER ---
        return (
            <UnstyledButton className={`button_DEPRECATED ${className}`} ref={ref} {...buttonProps}>
