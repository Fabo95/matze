...
const Loading = () => {
    ...
    const pageBlockStart = useMemo(() => <Skeleton className="home-page-loading-block-start" />, []);

    const pageBlockEnd = useMemo(() => <Skeleton className="home-page-loading-block-end" />, []);
