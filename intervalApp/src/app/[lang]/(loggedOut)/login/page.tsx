...
export default async function Login({
    ...
    const emailValidationError = emailError && t(`pages.login.validationError.${emailError}`);

    const passwordValidationError = passwordError && t(`pages.login.validationError.${passwordError}`);
