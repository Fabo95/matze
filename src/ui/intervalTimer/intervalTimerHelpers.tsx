...
export const getIntervalTimerSettingOptions = ({
...
}) => [
  {
    ...
    icon: <PlayIcon className="mr-1 stroke-green-dark" />,
  ...
  },
  {
    ...
    icon: <PauseIcon className="mr-1 stroke-red-primary" />,
